        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900" style="text-align: center">
                    ...
                    <br>
                    <a href="{{route('cv')}}" style="background-color: blue; color:white; padding: 3px">View CV</a>
                    <a href="{{route('flazz_card')}}" style="background-color: blue; color:white; padding: 3px">View Flazz Card</a>
                    <a href="{{route('id_card')}}" style="background-color: blue; color:white; padding: 3px">View ID Card</a>
                    <br>
                    <br>
                    <a href="{{route('add_member')}}" style="background-color: red; color:white; padding: 3px">Add Member (Max 3x)</a>
                    <br>
                    <br>
